...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        private void aboutMe() {
            ...
            alert.setHeaderText("Gurkanwal Kaur");
            alert.setContentText("I love creating new applications for Desktop,Mobile and Web. " +
                    "Connect 4 is one of them.I hope you all will love to play this game and share with your friends. ");
